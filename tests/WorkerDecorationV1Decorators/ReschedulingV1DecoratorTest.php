...
use Neighborhoods\KojoWorkerDecoratorComponent\WorkerDecorationV1Decorators\ReschedulingV1\ReschedulingDecorator;
...
class ReschedulingV1DecoratorTest extends TestCase
{
    private $decorator;
    /**
     * @var PDO&MockObject
    ...
    public function testWorkShouldRunAnIncompleteWorkerAndCompleteAndRescheduleItWithDelay(): void
    {
        ...
        $workerMock->expects(self::once())
            ->method('work')
            ->willReturnSelf();
        $this->decorator->setWorkerDecorationV1Worker($workerMock);
        $this->kojoWorkerServiceMock
            ->expects(self::once())
